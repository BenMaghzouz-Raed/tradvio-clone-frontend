...
import BudgetWarning from "@/components/icons/warning";
...
export default function AdminPanel() {
  ...
  return (
    <main className="space-y-6">
      ...
      {/* Tabs */}
      <nav className="flex gap-4 text-sm font-medium border-b border-neutral-200">
        {tabs.map((tab) => (
          <button
            key={tab}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    >
                      {isCompleted ? (
                        ...
                        <Exclamation className="w-8 h-8 text-blue-600" />
                      ) : (
                        "•"
                      )}
                    </span>
